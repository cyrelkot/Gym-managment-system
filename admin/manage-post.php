...
<head>
    ...
    <style>
        ...
        h3, .table, .table th, .table td { color: #fff !important; }
        hr { border-top: 1px solid rgba(255,102,0,0.35); }
        .table-bordered, .table-bordered th, .table-bordered td {
            border: 1px solid rgba(255,255,255,0.12) !important;
        }
        .table thead { background: rgba(255,102,0,0.12); }
        .table-hover tbody tr:hover { background: rgba(255,102,0,0.08); }
        .btn-success { background: #ff6600; border-color: #ff6600; }
        .btn-success:hover, .btn-success:focus { background: #e65c00; border-color: #e65c00; }
    </style>
</head>
