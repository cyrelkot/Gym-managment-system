...
<header class="app-header"><a class="app-header__logo" href="index.php">GYM MS</a>
      ...
      <ul class="app-nav">
        ...
        <!-- User Menu-->
        <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Open Profile Menu">Welcome : <?php echo htmlspecialchars($_SESSION['email'] ?? 'Admin', ENT_QUOTES, 'UTF-8'); ?> <i class="fa fa-user fa-lg"></i></a>
